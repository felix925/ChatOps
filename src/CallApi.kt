...
class CallApi(token:String){
    private val commands: String = "curl¥ -X ¥POST¥ -H ¥\"Authorization: token ${token}\"¥ -H ¥\"Accept: application/vnd.github.everest-preview+json\"¥ -d ¥'{\"event_type\": \"repository_dispatch\"}'¥ -i ¥https://api.github.com/repos/SoyBeansLab/daizu-ChatOps/dispatches"
