...
class CallApi(token:String){
    private val commands: String = "curl -H \"Authorization: token ${token}\" -H \"Accept: application/vnd.github.everest-preview+json\" https://api.github.com/repos/felix925/ChatOps/dispatches"
