...
class CallApi(token:String){
    private val commands: String = "curl¥-X¥GET¥-H¥\"Authorization: token ${token}\"¥-H¥\"Accept: application/vnd.github.everest-preview+json\"¥-d¥'{\"event_type\": \"Test\"}'¥-i¥https://api.github.com/repos/SoyBeansLab/daizu-ChatOps/dispatches"
