...
class CallApi(token:String){
    private val commands: String = "curl¥ -X ¥POST¥ -H ¥\"Authorization: token ${token}\"¥ -H ¥\"Accept: application/vnd.github.v3+json\"¥ -d ¥'{\"event_type\": \"TEST_ACCESS\"}'¥ https://api.github.com/repos/SoyBeansLab/daizu-ChatOps/dispatches"
