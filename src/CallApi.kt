...
class CallApi(repository: Repository){
    ...
    private val command = "curl¥GET¥-H¥\"Authorization:token ${TOKEN}\"¥-H¥\"Accept:application/vnd.github.everest-preview+json\"¥-d¥'{\"event_type\":\"custom.preview\"}'¥-i¥https://api.github.com/repos/SoyBeansLab/${repository.value}/dispatches"
